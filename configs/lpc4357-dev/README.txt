...
README for NuttX port to the LPC4357-DEV board from Embest featuring the NXP
LPC4357FET256 MCU - The port was derived from the LPC4357-DEV board NuttX
port.

Contents
========

  - LPC4357-DEV development board
  - Status
  ...
  - Serial Console
  - FPU
  - LPC4357-DEV Configuration Options
  - Configurations
  - STATUS
...
^^^^^^^^^^^^^^^^^^
  ...
  found in the configs/lpc4357-dev/scripts directory can do that with
  ...
  To boot the LPC4357-DEV from SPIFI the DIP switches should be 1-OFF,
...
The LPC4357-DEV does not have RS-232 drivers or serial connectors on board.
...
=====================================
    ...
    CONFIG_ARCH_BOARD - Identifies the configs subdirectory and
       ...
       CONFIG_ARCH_BOARD=lpc4357-dev (for the LPC4357-DEV board)
...
Each LPC4357-DEV configuration is maintained in a sub-directory and can be selected
as follow:

    cd tools
    ./configure.sh lpc4357-dev/<subdir>
    cd -
    . ./setenv.sh
...
Where <subdir> is one of the following:
  ...
  ----
   ...
   6. By default the LPC4357-DEV port is configured to run from the onboard flash
...
======
  ...
  1. This configuration derives from the LPC4330 Xplorer configuration.  In
     ...
     LPC4357 DEV without corresponding updates to the technical description.
